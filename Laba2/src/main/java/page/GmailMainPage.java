...
public class GmailMainPage {
  ...
  private String getMessageContentOrSubject(WebElement messageRowElement, boolean isContent) {
    var split = messageRowElement.getText().split("\n");
  ...
  public GmailMainPage checkMessage(int messageIndex, boolean isInbox) {
    ...
    var messageRowElement = webDriver.findElement(By.cssSelector(format(rowCssSelector, messageIndex)));
  ...
  public GmailMainPage clickOnMessage(int messageIndex) {
    var messageRowElement = webDriver.findElement(By.cssSelector(format(MESSAGE_ROW_CSS_SELECTOR, messageIndex)));
